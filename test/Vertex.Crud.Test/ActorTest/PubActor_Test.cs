...
namespace Vertex.Crud.Test.ActorTest
{
    ...
    public class PubActor_Test
    {
        ...
        public PubActor_Test(Core.ClusterFixture fixture)
        {
        ...
        public async Task Archive(int count, int id)
        {
            ...
            await accountActor.SetArchiveOptions(new Runtime.Options.ArchiveOptions { MinIntervalSeconds = 1, RetainSeconds = 1 });
